...
public class OpenBattleTutorial : MonoBehaviour {
	...
	IEnumerator OnTriggerEnter2D (Collider2D other){ //ao entrar na área ao redor do boss		
		...
		gatilhoParaBatalha.GetComponent<GatilhoTutorial> ().falaTrigger = true; // faz o jogador ficar parado
		...
		gatilhoParaBatalha.GetComponent<GatilhoTutorial> ().battleTrigger = true;
